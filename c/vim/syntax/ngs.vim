...
syn keyword ngsType Any Arr BasicType Bool CLib Command CSym ExclusiveRange ExecutableNotFound FFI Fun Hash InclusiveRange Int NormalType NormalTypeInstance Null Path Pipe Process ProcessFail Range Seq Stats Str Table TableMeta TableMetaNotIfCol Type
