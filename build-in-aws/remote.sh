...
for p in git moreutils docker.io bash-completion rsync debootstrap curl vim libgc-dev libffi6 libffi-dev libjson-c2 libjson-c-dev peg libpcre2-dev make pandoc;do
	pkg "$p"
done
